package org.firstinspires.ftc.teamcode.localization.pedroLocalizers;
...
public class OTOSLocalizer extends Localizer {
    ...
    public OTOSLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        totalHeading = 0;
        previousHeading = startPose.getTheta();
    ...
    public void setPose(Pose setPose) {
        ...
        otos.setPosition(new SparkFunOTOS.Pose2D(setOTOSPose.getX(), setOTOSPose.getY(), setOTOSPose.getTheta()));
    }
