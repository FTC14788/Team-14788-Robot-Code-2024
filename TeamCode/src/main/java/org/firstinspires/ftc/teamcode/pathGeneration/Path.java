...
public class Path {
    ...
    private double zeroPowerAccelerationMultiplier = DriveConstnats.zeroPowerAccelerationMultiplier;

    // When the robot is at the end of its current Path or PathChain and the velocity goes below
    // this value, then end the Path. This is in inches/second.
    // This can be custom set for each Path.
    private double pathEndVelocityConstraint = DriveConstnats.pathEndVelocityConstraint;
    ...
    // This can be custom set for each Path.
    private double pathEndTranslationalConstraint = DriveConstnats.pathEndTranslationalConstraint;

    // When the robot is at the end of its current Path or PathChain and the heading error goes
    // below this value, then end the Path. This is in radians.
    // This can be custom set for each Path.
    private double pathEndHeadingConstraint = DriveConstnats.pathEndHeadingConstraint;

    // When the t-value of the closest point to the robot on the Path is greater than this value,
    // then the Path is considered at its end.
    // This can be custom set for each Path.
    private double pathEndTValueConstraint = DriveConstnats.pathEndTValueConstraint;

    // When the Path is considered at its end parametrically, then the Follower has this many
    // seconds to further correct by default.
    // This can be custom set for each Path.
    private double pathEndTimeoutConstraint = DriveConstnats.pathEndTimeoutConstraint;
