...
public class FowardTuner extends OpMode {
    ...
    public void loop() {
        ...
        telemetryA.addData("distance moved", poseUpdater.getEstimatedPose().getX());
        ...
        telemetryA.addData("multiplier", DISTANCE / (poseUpdater.getEstimatedPose().getX() / poseUpdater.getLocalizer().getForwardMultiplier()));
        telemetryA.update();
