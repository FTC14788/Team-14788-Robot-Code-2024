...
public class LateralTuner extends OpMode {
    ...
    public void init() {
        ...
        Drawing.drawRobot(poseUpdater.getEstimatedPose(), "#4CAF50");
        Drawing.sendPacket();
    }
    ...
    public void loop() {
        ...
        telemetryA.addData("distance moved", poseUpdater.getEstimatedPose().getY());
        ...
        telemetryA.addData("multiplier", DISTANCE / (poseUpdater.getEstimatedPose().getY() / poseUpdater.getLocalizer().getLateralMultiplier()));
        telemetryA.update();
