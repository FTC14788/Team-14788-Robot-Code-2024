...
public class LocalizationTest extends OpMode {
    ...
    public void loop() {
        ...
        telemetryA.addData("x", poseUpdater.getEstimatedPose().getX());
        telemetryA.addData("y", poseUpdater.getEstimatedPose().getY());
        telemetryA.addData("heading", poseUpdater.getEstimatedPose().getTheta());
