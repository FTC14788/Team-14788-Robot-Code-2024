...
import org.firstinspires.ftc.teamcode.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.util.KalmanFilterParameters;
...
public class DriveConstnats {
    ...
    // Kalman filter parameters for vision measurement Kalman filter
    public static double odometryTranslationCovariance = 1;
    public static double odometryRotationCovariance = 0.01;
    public static double processNoiseTranslationCovariance = 0.01;
    public static double processNoiseRotationCovariance = 0.001;

    public static double ambiguityThresholdRadians = 0.02;



    // Odometry related constants
    public static final double poseBufferSpan = 100;
